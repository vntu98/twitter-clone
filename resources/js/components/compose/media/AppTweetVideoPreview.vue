<template>
    <div class="mb-4 relative">
        ...
        <a
            ...
            class="bg-gray-900 w-8 h-8 rounded-full absolute top-0 right-0 mt-3 mr-8 flex items-center justify-center"
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="full-current text-gray-300">
